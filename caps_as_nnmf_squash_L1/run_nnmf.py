...
parser.add_argument(
    "--test-batch-size", type=int, default=100, help="test batch size (default: 100)"
)
# -------
# Network structure:
parser.add_argument(
    "--number-of-classes", type=int, default=10, help="number of classes (default: 10)"
)
parser.add_argument(
    "--conv1-in-channels", type=int, default=1, help="conv1 in channels (default: 1)"
)
parser.add_argument(
    "--conv1-out-channels",
    type=int,
...
parser.add_argument(
    "--conv1-kernel-size", type=int, default=9, help="conv1 kernel size (default: 9)"
)
parser.add_argument(
    "--conv1-stride", type=int, default=1, help="conv1 stride (default: 1)"
)
parser.add_argument(
    "--conv2-kernel-size", type=int, default=9, help="conv2 kernel size (default: 9)"
)
parser.add_argument(
...
parser.add_argument(
    "--fc1-out-features", type=int, default=512, help="fc1 out features (default: 512)"
)
parser.add_argument(
    "--fc2-out-features",
    type=int,
...
parser.add_argument(
    "--fc3-out-features", type=int, default=784, help="fc3 out features (default: 784)"
)
# reconstruction
parser.add_argument(
    "--with-reconstruction",
